About profimp-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/profimp-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/boris-42/profimp
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4615&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/profimp-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `profimp` can be installed with `conda`:
...
```
mamba install profimp
```

It is possible to list all of the versions of `profimp` available on your platform with `conda`:
...
```
mamba search profimp --channel conda-forge
```
...
mamba repoquery search profimp --channel conda-forge

# List packages depending on `profimp`:
mamba repoquery whoneeds profimp --channel conda-forge

# List dependencies of `profimp`:
mamba repoquery depends profimp --channel conda-forge
```
